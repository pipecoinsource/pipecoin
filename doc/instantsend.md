...
This mechanism has been integrated into Bitcore-Node-Pipe which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pipecoin/insight-api-pipe#web-socket-api](https://github.com/pipecoin/insight-api-pipe#web-socket-api) 
* API: [https://github.com/pipecoin/insight-api-pipe#instantsend-transactions](https://github.com/pipecoin/insight-api-pipe#instantsend-transactions) 
...
By default, the Pipe Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pipe Core daemon:
