...
Only requiring some minor changes is pipe.cpp.
...
Changes to pipe.cpp
----------------------
pipe.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
