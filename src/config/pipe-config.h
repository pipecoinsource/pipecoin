/* src/config/pipe-config.h.  Generated from pipe-config.h.in by configure.  */
/* src/config/pipe-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PIPE_CONFIG_H

#define PIPE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/pipecoin/pipecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Pipe Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Pipe Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pipecore"
