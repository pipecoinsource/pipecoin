 ...
 *
 *   // network
 *   CPipeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pipecoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPipeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PipeNetwork
// //   -- signature requirements : Key1(User)
// class CPipeNetworkVariable : public CGovernanceObject
// {
// private:
