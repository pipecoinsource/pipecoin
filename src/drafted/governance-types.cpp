...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PipeNetwork") type = PipeNetwork;
    if(strType == "PipeNetworkVariable") type = PipeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PipeNetwork) s = "PipeNetwork";
    if(type == PipeNetworkVariable) s = "PipeNetworkVariable";
