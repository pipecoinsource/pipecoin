    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Pipe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pipe address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pipe: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Pipe Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pipe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pipe Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pipe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pipe addresses"));
    ...
    openAction->setStatusTip(tr("Open a pipe: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pipe Core help message to get a list with possible Pipe Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pipe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pipe network", "", count));
}
...
{
    QString strTitle = tr("Pipe Core"); // default title
