    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pipe Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Pipe Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pipe-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pipe in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an pipetive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 PIPE, 0.1 PIPE, 1 PIPE and 10 PIPE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pipecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://pipecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pipe Core is shutting down...") + "<br /><br />" +
